...
TEST_F(SoftmaxTests, Softmax) {
    ...
    const std::vector<float> data({0.4301911, 0.54719144, -1.1637765, 0.18390046, 0.58390397,
    ...
    const std::vector<float> expectedValue({0.32165375, 0.36157736, 0.0653337, 0.25143513,
