...
TEST_F(TransposeTests, transpose_default) {
    Transpose* transpose_default = new Transpose();
    transpose_default->SetInput(
    ...
    transpose_default->SetExpectedBuffer(
    ...
    EXPECT_TRUE(utils::Test(transpose_default));
}

TEST_F(TransposeTests, transpose_permutations_1) {
    Transpose* transpose_permutations_1 = new Transpose();
    transpose_permutations_1->SetInput(
        {2, 3, 4}, {
    ...
    EXPECT_TRUE(utils::Test(transpose_permutations_1));
}

TEST_F(TransposeTests, transpose_permutations_2) {
    Transpose* transpose_permutations_2 = new Transpose();
    transpose_permutations_2->SetInput(
        {2, 3, 4}, {
                       0.7760998,  0.8363521,  0.10145967, 0.00533229, 0.8190919,  0.83241564,
                       0.39479077, 0.5622921,  0.9306249,  0.00480607, 0.39600816, 0.35415828,
                       0.43689877, 0.7603583,  0.14368972, 0.11940759, 0.4834097,  0.6982117,
    ...
    EXPECT_TRUE(utils::Test(transpose_permutations_2));
}

TEST_F(TransposeTests, transpose_permutations_3) {
    Transpose* transpose_permutations_3 = new Transpose();
    transpose_permutations_3->SetInput(
        {2, 3, 4}, {
                       0.7760998,  0.8363521,  0.10145967, 0.00533229, 0.8190919,  0.83241564,
                       0.39479077, 0.5622921,  0.9306249,  0.00480607, 0.39600816, 0.35415828,
                       0.43689877, 0.7603583,  0.14368972, 0.11940759, 0.4834097,  0.6982117,
    ...
    EXPECT_TRUE(utils::Test(transpose_permutations_3));
}

TEST_F(TransposeTests, transpose_permutations_4) {
    Transpose* transpose_permutations_4 = new Transpose();
    transpose_permutations_4->SetInput(
        {2, 3, 4}, {
                       0.7760998,  0.8363521,  0.10145967, 0.00533229, 0.8190919,  0.83241564,
                       0.39479077, 0.5622921,  0.9306249,  0.00480607, 0.39600816, 0.35415828,
                       0.43689877, 0.7603583,  0.14368972, 0.11940759, 0.4834097,  0.6982117,
    ...
    EXPECT_TRUE(utils::Test(transpose_permutations_4));
}

TEST_F(TransposeTests, transpose_permutations_5) {
    Transpose* transpose_permutations_5 = new Transpose();
    transpose_permutations_5->SetInput(
        {2, 3, 4}, {
                       0.7760998,  0.8363521,  0.10145967, 0.00533229, 0.8190919,  0.83241564,
                       0.39479077, 0.5622921,  0.9306249,  0.00480607, 0.39600816, 0.35415828,
                       0.43689877, 0.7603583,  0.14368972, 0.11940759, 0.4834097,  0.6982117,
    ...
    EXPECT_TRUE(utils::Test(transpose_permutations_5));
}

TEST_F(TransposeTests, transpose_permutations_6) {
    Transpose* transpose_permutations_6 = new Transpose();
    transpose_permutations_6->SetInput(
        {2, 3, 4}, {
                       0.7760998,  0.8363521,  0.10145967, 0.00533229, 0.8190919,  0.83241564,
                       0.39479077, 0.5622921,  0.9306249,  0.00480607, 0.39600816, 0.35415828,
                       0.43689877, 0.7603583,  0.14368972, 0.11940759, 0.4834097,  0.6982117,
    ...
    EXPECT_TRUE(utils::Test(transpose_permutations_6));
}