...
TEST_F(MatMulTests, mat_mul_1d) {
    ...
    EXPECT_TRUE(utils::Test(mat_mul_1d));
}

TEST_F(MatMulTests, mat_mul_1dx2d) {
    ...
    EXPECT_TRUE(utils::Test(mat_mul_1dx2d));
}

TEST_F(MatMulTests, mat_mul_2dx1d) {
    ...
    EXPECT_TRUE(utils::Test(mat_mul_2dx1d));
}

TEST_F(MatMulTests, mat_mul_2d) {
    ...
    mat_mul_2d->SetExpectedBuffer({1.5347629, -0.3981255, 2.6510081, -0.14295794, 0.6647107,
                                   -0.70315295, 1.3096018, 3.9256358, 3.873897});
    mat_mul_2d->SetExpectedShape({3, 3});
    EXPECT_TRUE(utils::Test(mat_mul_2d));
}

TEST_F(MatMulTests, mat_mul_3d) {
    ...
    EXPECT_TRUE(utils::Test(mat_mul_3d));
}

TEST_F(MatMulTests, mat_mul_3dx2d) {
    MatMulModel* mat_mul_3dx2d = new MatMulModel();
    mat_mul_3dx2d->SetInput(
        {2, 3, 4}, {
    ...
    EXPECT_TRUE(utils::Test(mat_mul_3dx2d));
}

TEST_F(MatMulTests, mat_mul_3dx2d_3d) {
    ...
    EXPECT_TRUE(utils::Test(mat_mul_3dx2d_3d));
}

TEST_F(MatMulTests, mat_mul_4d) {
    ...
    EXPECT_TRUE(utils::Test(mat_mul_4d));
}